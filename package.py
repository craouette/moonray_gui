...
variants = [
    ...
    # ['os-rocky-9', 'opt_level-optdebug', 'refplat-vfx2024.0', 'gcc-11.x'],  # This won't build until we upgrade to Qt 6
    # ['os-rocky-9', 'opt_level-optdebug', 'refplat-vfx2025.0', 'gcc-11.x'],  # This won't build until we upgrade to Qt 6
